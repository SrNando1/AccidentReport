...
const DriversData = () => {
  ...
  const buttonScreens = ["Driver Data A", "Driver Data B"];
  ...
  useEffect(() => {
    if (isFocused) {
      ...
      setFilledStatus({
        "Driver Data A": DataDriverAFilled,
        "Driver Data B": DataDriverBFilled,
      });
    }
  }, [isFocused]);
  return (
    <ScrollView>
      <View style={screen.container}>
        ...
        <View style={screen.header}>
          <Text style={screen.title}>Drivers Data</Text>
        </View>
