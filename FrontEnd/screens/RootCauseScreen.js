    ...
    <ScrollView contentContainerStyle={globalStyles.container}>
      <View style={globalStyles.formGroup}>
        <View style={globalStyles.formGroup1}>
          <Text style={globalStyles.label}>4. Contributing Factors</Text>
          <TextInput
        ...
        <View style={globalStyles.formGroup1}>
          {/* Tipo de Causa */}
          <Text style={globalStyles.label}>5. Type of Cause</Text>
        ...
        <View style={globalStyles.formGroup1}>
          <Text style={globalStyles.label}>6. Internal Procedures</Text>
          <TouchableOpacity
            onPress={() =>
              Platform.OS === "web"
          ...
          >
            {files["6"]?.length > 0 ? (
              files["6"].map((file, i) => (
                <View key={i}>
                  <Text style={ActionsDevelopedScreen.fileLabel}>File:</Text>
                  <Text style={ActionsDevelopedScreen.fileText}>
                    {file.name}
                  </Text>
                  <Text style={ActionsDevelopedScreen.fileLabel}>Date:</Text>
                  <Text style={ActionsDevelopedScreen.fileText}>
                    {file.modified}
                  </Text>
                  <View
                  ...
                  >
                    <TouchableOpacity
                      ...
                      style={{ marginTop: 5 }}
                    >
                      <Text style={{ color: "blue" }}>Rename ✏️</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
        ...
        <View style={globalStyles.formGroup1}>
          <Text style={globalStyles.label}>7. Other Preventive Actions</Text>
          <TextInput
            style={[globalStyles.input]}
            value={preventiveactions}
            onChangeText={setPreventiveactions}
            placeholder="Describe the contributing factors"
            placeholderTextColor="red"
          />
        </View>
      </View>
      ...
      <Modal visible={modalVisible} animationType="slide" transparent>
        <View style={ModalStyles.modalBackdrop}>
          <View style={ModalStyles.modalContainer}>
            <Text style={ModalStyles.modalTitle}> Rename file</Text>
            <TextInput
